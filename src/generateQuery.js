...
import SunburstHierarchical from './SunburstHierarchical.js';
...
function helperJson(data, score, flag, colors, typeObj) {
    ...
    jsonHelper.createHierarchicalJson('true' === flag, colors === 'true')
...
export { generateQuery, helperJson, generateQueryForScoresNoHeuristics };